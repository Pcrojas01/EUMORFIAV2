          ...
          {cart.length === 0 ? (
            ...
            <>
              <div className="space-y-4 mb-6">
                {cart.map((item) => (
                  <div key={`${item.id}-${item.selectedSize}-${item.selectedColor}`} className="flex gap-4 p-4 border rounded-lg bg-gray-50">
                    <img
                      src={item.image}
                      alt={item.name}
        ...
        {cart.length > 0 && (
          <div className="sticky bottom-0 bg-white border-t border-gray-200 p-4">
            ...
            <button 
              ...
              className="w-full px-6 py-3 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 transition-colors duration-300 flex items-center justify-center gap-2"
            >
